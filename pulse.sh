...
do
    ...
    sleep 0.07
    sudo ectool lightbar 0 00 00 00
    sudo ectool lightbar 1 FF 00 00
    sleep 0.07
    sudo ectool lightbar 1 00 00 00
    sudo ectool lightbar 2 FF 00 00
    sleep 0.07
    sudo ectool lightbar 2 00 00 00
    sudo ectool lightbar 3 FF 00 00
    sleep 0.07
    sudo ectool lightbar 3 00 00 00
    sudo ectool lightbar 2 FF 9A 00
    sleep 0.07
    sudo ectool lightbar 2 00 00 00
    sudo ectool lightbar 1 FF 9A 00
    sleep 0.07
    sudo ectool lightbar 1 00 00 00
    sudo ectool lightbar 0 FF 9A 00
    sleep 0.07
    sudo ectool lightbar 0 00 00 00
